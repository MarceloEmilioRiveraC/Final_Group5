...
const validateStatsData = (stats: Stats | null): stats is Stats => {
  ...
  // WHY: Check for required fields that are used in render
  return (
    ...
    (stats.topPost === null || (
      typeof stats.topPost._id === 'string' &&
      ...
      <div className="bg-white rounded-2xl p-6 mb-8 shadow-sm border border-gray-100">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <LineChart data={chartData}>
            {/* Grid: Subtle background grid for reading values */}
            <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
            
            {/* Axes: Labeled for data interpretation */}
            <XAxis
              dataKey="month"
            ...
            {/* Tooltip: Interactive value display on hover */}
            <Tooltip
              contentStyle={{
                borderRadius: '12px',
                border: 'none',
          ...
          {stats.topPost ? (
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {/* Badge: Visual indicator for featured status */}
